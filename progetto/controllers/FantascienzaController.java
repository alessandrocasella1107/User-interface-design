...
public class FantascienzaController {
    ...
    @FXML
    void morbius_recensione(ActionEvent event) {
        Home.getInstance().createMorbius();
    }

    @FXML
    void venom_recensione(ActionEvent event) {
        Home.getInstance().createVenom();
    }

    @FXML
    void avatar_recensione(ActionEvent event) {
        Home.getInstance().createAvatar();
    }

    @FXML
    void matrix_recensione(ActionEvent event) {
        Home.getInstance().createMatrix();
    }
}
