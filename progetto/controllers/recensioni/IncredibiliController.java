...
public class IncredibiliController implements Initializable {
    ...
    public void loadPage(){
        engine.load("https://www.youtube.com/embed/I7KZ6MKH5B4");
    }

    @FXML
    void Animazione(ActionEvent event) {
        Home.getInstance().createAnimazione();
